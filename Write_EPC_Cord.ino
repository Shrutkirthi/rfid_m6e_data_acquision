...
void setup()
{
  ...
  rfidModule.setRegion(REGION_INDIA); //Set to North America
...
void loop()
{
  ...
  char stringEPC[] = "R70210xx0360"; //You can only write even number of bytes
  byte responseType = rfidModule.writeTagEPC(stringEPC, sizeof(stringEPC) - 1); //The -1 shaves off the \0 found at the end of string
